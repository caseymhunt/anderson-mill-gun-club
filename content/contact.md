...
title: "Contact"
label: "Get in Touch"
subtitle: "Questions, introductions, or just want to say hello — we'd love to hear from you."
---
...
<form class="contact-form" action="https://formspree.io/f/xlgvyjrk" method="POST">
  ...
  <div>
    ...
    <textarea id="message" name="message" placeholder="Whatever's on your mind…" required></textarea>
  </div>
